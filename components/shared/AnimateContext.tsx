...
export const PageAnimationContext = createContext<ContextType | undefined>(undefined);

export const PageAnimationProvider: React.FC<React.PropsWithChildren<{}>> = ({ children }) => {
